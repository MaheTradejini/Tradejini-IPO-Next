...
<footer className="relative z-30 mt-10 rounded-t-[40px] bg-[#005B6C] px-5 pb-20 pt-20 md:px-10 lg:px-20 xl:px-32">
  ...
  <div className="mt-10">
    <p className="text-[8px] font-bold text-white/50 md:text-xs">
      ...
      related documents carefully before investing. The securities are quoted as
      an example and not as a recommendation.
      <br />
      “Prevent Unauthorized Transactions in your trading/demat account Update
      your Mobile Number/Email IDs with your Stock brokers/Depository
      Participant.Receive alerts/information of your transactions on your
      Registered Mobile/Email for all debit and other important transactions in
      your trading/demat account directly from Exchange/CDSL on the same day”.
      <br />
      ...
      the bank account number and sign in the application form to authorize your
      bank to make payment in case of allotment. No worry for refund as the
      money remains in investor’s account.
      <br />
      <br />
      This is to inform you as per Rules, Regulations and Bye-laws of Multi
      Commodity Exchange of India Ltd (MCX),that we do client based trading and
      proprietary trading.
      <br />
      Procedure to file a complaint on SCORES (Easy &amp; quick). Register on
      SCORES portal and have the mandatory details for filing complaints on
      SCORES (Name, PAN, Address, Mobile Number and E-mail ID). Benefits:
      ...
      pledge in the depository system w.e.f. September 01, 2020 Update your
      email id and mobile number with your stock broker / depository participant
      and receive OTP directly from depository on your email id and/or mobile
      number to create pledge Check your securities / MF / bonds in the
      consolidated account statement issued by NSDL/CDSL every month.
      <br />
      <br />
      Please be informed that we, TRADEJINI Financial Services Pvt. Ltd., are
      not associated with and have not granted any right/permission to use our
      name, trademark, logo etc. to any third-party platform and/or service
      provider which is directly or indirectly providing any reference to the
      past or expected future return/performance of any algorithm and/or trading
      strategy.
      <br />
      <br />
      Accordingly, any such third-party should not be deemed to be our agent,
      business partner and/or associate in any manner whatsoever.
      <br />
      <br />
      In case our name, trademark, logo etc., is being reflected/used by any
      such third-party platform and/or service provider, kindly inform us at the
      earliest to enable us to take appropriate action in law.
    </p>
    ...
    <div className="mt-20 grid place-items-center text-xs">
