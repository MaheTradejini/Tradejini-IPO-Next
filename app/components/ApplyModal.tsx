      ...
      <div className="bg-white rounded-lg p-4 sm:p-8 w-full max-w-3xl relative">
        <div className="grid md:grid-cols-2 gap-4 sm:gap-8">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              />
              <p className="text-base sm:text-lg mb-2 sm:mb-4">Scan to apply for an IPO</p>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base">Scan QR with your mobile camera</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <QrCode className="text-[#38B990]" size={20} />
                  <span className="text-sm sm:text-base">Complete IPO application via UPI</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 sm:mt-8 border-t pt-6 sm:pt-8">
          <h3 className="text-lg sm:text-xl font-semibold text-center mb-4 sm:mb-6">
            Open your <span className="text-[#1E8C51]">Tradejini</span> account in 5 mins
          </h3>
